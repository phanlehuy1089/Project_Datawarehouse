...
public class CreateTable {
	public static void createTable(InfoConfig infoConfig, String dbName, String tbName, String fieldName, String fieldFormat) {
	...
	public static void main(String[] args) {
		...
		createTable(infoConfig, dbName, "haha", fieldName, fieldFormat);
	}
}
